    ...
    <div className="hp-root">
      ...
      <nav className="hp-nav">
        ...
        <div className="hp-nav-brand">
          <img src="/logo.png" alt="Yoselin's Cleaning" style={{ height: '96px', objectFit: 'contain' }} />
        </div>
      ...
      <footer className="hp-footer">
        ...
        <div className="hp-footer-brand">
          <img src="/logo.png" alt="Yoselin's Cleaning" style={{ height: '80px', objectFit: 'contain', marginBottom: '8px' }} />
        </div>
