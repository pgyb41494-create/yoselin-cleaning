        ...
        {!request ? (
          ...
          <div style={{ background: '#111', borderRadius: '20px', border: '1px solid #222', overflow: 'hidden' }}>
            <div style={{ background: '#0d0d0d', padding: '16px 22px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid #1f1f1f' }}>
              <div style={{ fontWeight: '700', color: 'white', fontSize: '.95rem' }}>Request #{request.id.slice(-6).toUpperCase()}</div>
            ...
            <div style={{ padding: '52px 28px', textAlign: 'center' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'center' }}>
                <a href="/book?new=1" style={{ display: 'inline-block', padding: '14px 36px', background: 'linear-gradient(135deg, #1a6fd4, #db2777)', color: 'white', borderRadius: '99px', fontWeight: '700', textDecoration: 'none', fontSize: '.95rem', boxShadow: '0 4px 20px rgba(26,111,212,.3)' }}>
